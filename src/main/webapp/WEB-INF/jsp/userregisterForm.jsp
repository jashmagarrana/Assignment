...
<div class="form-container">
    ...
    <form class="form-registerUser" method="POST" action="registerUserProcess">
        ...
        <div class="form-group">
            ...
            <input type="password" id="upassword" name="upassword" class="form-control" placeholder="Password" minlength="8" maxlength="14" required>
        </div>

        <div class="pass-type">
            <label>Password must be 8 to 14 characters long.</label>
        </div>
